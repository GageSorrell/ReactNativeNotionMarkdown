...
`./provider` exports `MarkdownProvider`, the theme, and the message catalog. Both `./editor/ui` and `./renderer/ui` re-export it, so you rarely need to import it directly. See [Customization](/docs/v1/guides/customization).
